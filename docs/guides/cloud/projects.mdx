...
&#8239<Icon name="check-circle" color="green" /> Make sure to [install](/guides/getting-started/installing-cypress) and
[open](/guides/getting-started/opening-the-app) the Cypress app to get started recording!
...
5. If you don't have any existing projects, you'll have the opportunity to
   ...
   one, you can click **Create new** to make a new one.
    ...
    - Choose whether this project is Public or Private.
      ...
      - **A public project** can have its recordings and runs seen by _anyone_ (typically open source projects).
