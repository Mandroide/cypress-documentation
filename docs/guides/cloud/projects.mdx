...
5. If you don't have any existing projects, you'll have the opportunity to
   ...
   - Fill in the name of your project (this is only for display purposes and can
     be changed later).
   - Choose whether this project is
     [Public or Private](projects#Public-vs-Private).
     <!-- prettier mangles this list without manual breaks -->
     <br />
     <br />
     <DocsImage
...
<!-- prettier-ignore -->
- &#8239;<Logo color="black" src="/img/logo/github.svg" /> [GitHub integration guide](/guides/cloud/github-integration)
...
- &#8239;<Logo src="/img/logo/microsoft-teams.svg" /> Cypress integration for
